...
df_all['df_pcapdev1'] = pd.DataFrame()
df_all['df_pcapdev2'] = pd.DataFrame()
    ...
    if file_extension == '.csv':
        ...
        if df.iloc[0]['device'] == 'dev1':
            if index_pcaplatencydev1 == 0:
                df_all['df_pcapdev1'] = df
            else:
                df_all['df_pcapdev1'] = df_all['df_pcapdev1'].append(df,ignore_index=False)
            index_pcaplatencydev1 = index_pcaplatencydev1 + 1
        elif df.iloc[0]['device'] == 'dev2':
            if index_pcaplatencydev2 == 0:
                df_all['df_pcapdev2'] = df
            else:
                df_all['df_pcapdev2'] = df_all['df_pcapdev2'].append(df,ignore_index=False)
...
if rb_blocks_file:
    ...
    df_resourceblocks = df_resourceblocks[df_resourceblocks['timestamp'].between(min_timestamp,max_timestamp)]
    df_resourceblocks['minutes'] = (df_resourceblocks['timestamp'] - min_timestamp) / (1000 * 60)
...
fig = make_subplots(rows=14, cols=1,
                    ...
                    subplot_titles=("Uplink Used RB", 
                                    ...
                                    "ping dev1", 
                                    "ping dev2", 
                                    "udp down latency dev1", 
                                    "udp up latency dev1", 
                                    "udp down latency dev2", 
                                    "udp up latency dev2"))
if 'Uplink Used RB Num' in df_resourceblocks:
    fig.add_trace(go.Scatter(x=df_resourceblocks['minutes'], y=df_resourceblocks['Uplink Used RB Num'], name="# of RB's per second up"),
                row=1, col=1)
if 'Downlink Used RB Num' in df_resourceblocks:
    fig.add_trace(go.Scatter(x=df_resourceblocks['minutes'], y=df_resourceblocks['Downlink Used RB Num'], name="# of RB's per second down"),
                row=2, col=1)

if 'up_Mbit_per_second' in df_all['df_iperfdev1']:
    fig.add_trace(go.Scatter(x=df_all['df_iperfdev1']['minutes'], y=df_all['df_iperfdev1']['up_Mbit_per_second'], name="Mbps up"),
              row=3, col=1)

if 'down_Mbit_per_second' in df_all['df_iperfdev1']:
    fig.add_trace(go.Scatter(x=df_all['df_iperfdev1']['minutes'], y=df_all['df_iperfdev1']['down_Mbit_per_second'], name="Mbps down"),
                row=4, col=1)

if 'lost_percent' in df_all['df_iperfdev1']:
    fig.add_trace(go.Scatter(x=df_all['df_iperfdev1']['minutes'], y=df_all['df_iperfdev1']['lost_percent'], name="lost_percent"),
                row=5, col=1)

if 'total_lost_percent' in df_all['df_iperfdev1']:
    fig.add_trace(go.Scatter(x=df_all['df_iperfdev1']['minutes'], y=df_all['df_iperfdev1']['total_lost_percent'], name="lost_percent"),
                row=5, col=1)

if 'up_Mbit_per_second' in df_all['df_iperfdev2']:
    fig.add_trace(go.Scatter(x=df_all['df_iperfdev2']['minutes'], y=df_all['df_iperfdev2']['up_Mbit_per_second'], name="Mbps up"),
                row=6, col=1)

if 'down_Mbit_per_second' in df_all['df_iperfdev2']:
    fig.add_trace(go.Scatter(x=df_all['df_iperfdev2']['minutes'], y=df_all['df_iperfdev2']['down_Mbit_per_second'], name="Mbps down"),
                row=7, col=1)

if 'lost_percent' in df_all['df_iperfdev2']:
    fig.add_trace(go.Scatter(x=df_all['df_iperfdev2']['minutes'], y=df_all['df_iperfdev2']['lost_percent'], name="lost_percent"),
                row=8, col=1)

if 'total_lost_percent' in df_all['df_iperfdev2']:
    fig.add_trace(go.Scatter(x=df_all['df_iperfdev2']['minutes'], y=df_all['df_iperfdev2']['total_lost_percent'], name="lost_percent"),
                row=8, col=1)

if 'time' in df_all['df_pingdev1']:
    fig.add_trace(go.Scatter(x=df_all['df_pingdev1']['minutes'], y=df_all['df_pingdev1']['time'], name="round trip latency"),
                row=9, col=1)

if 'time' in df_all['df_pingdev2']:
    fig.add_trace(go.Scatter(x=df_all['df_pingdev2']['minutes'], y=df_all['df_pingdev2']['time'], name="round trip latency"),
                row=10, col=1)

if 'down_latency' in df_all['df_pcapdev1']:
    fig.add_trace(go.Scatter(x=df_all['df_pcapdev1']['minutes'], y=df_all['df_pcapdev1']['down_latency'], name="down latency"),
                row=11, col=1)

if 'up_latency' in df_all['df_pcapdev1']:
    fig.add_trace(go.Scatter(x=df_all['df_pcapdev1']['minutes'], y=df_all['df_pcapdev1']['up_latency'], name="up latency"),
                row=12, col=1)

if 'down_latency' in df_all['df_pcapdev2']:
    fig.add_trace(go.Scatter(x=df_all['df_pcapdev2']['minutes'], y=df_all['df_pcapdev2']['down_latency'], name="down latency"),
                row=13, col=1)

if 'up_latency' in df_all['df_pcapdev2']:
    fig.add_trace(go.Scatter(x=df_all['df_pcapdev2']['minutes'], y=df_all['df_pcapdev2']['up_latency'], name="up latency"),
                row=14, col=1)

fig.update_layout(height=4600, width=1200,
...
fig.update_yaxes(title_text="Mbps", row=6, col=1)
fig.update_yaxes(title_text="Mbps", row=7, col=1)
fig.update_yaxes(title_text="perc. lost", row=8, col=1)
fig.update_yaxes(title_text="ms", row=9, col=1)
fig.update_yaxes(title_text="ms", row=10, col=1)
fig.update_yaxes(title_text="ms", row=11, col=1)
fig.update_yaxes(title_text="ms", row=12, col=1)
fig.update_yaxes(title_text="ms", row=13, col=1)
fig.update_yaxes(title_text="ms", row=14, col=1)
fig.show()
